    ...
    0: function (e, t, n) {
        ...
        function a(e) {
            for (var t = [], n = e.querySelectorAll("tr"), a = [], i = 0; i < n.length; ++i) {
                for (var o = [], r = n[i], c = r.querySelectorAll("td"), s = 0; s < c.length; ++s) {
                    var u = c[s], l = u.getAttribute("colspan"), d = u.getAttribute("rowspan"), f = u.innerText;
        ...
        function o(e, t) {
            for (var n = {}, a = {
                ...
                if (null != c.v) {
                    ...
                    "number" === typeof c.v ? c.t = "n" : "boolean" === typeof c.v ? c.t = "b" : c.v instanceof Date ? (c.t = "n", c.z = XLSX.SSF._table[14], c.v = i(c.v)) : c.t = "s", n[s] = c
                }
            }
        ...
        function s(e) {
            ...
            console.log("a");
            var n = a(t), i = n[1], s = n[0], u = "SheetJS";
            console.log(s);
            var l = new r, d = o(s);
            d["!merges"] = i, l.SheetNames.push(u), l.Sheets[u] = d;
            var f = XLSX.write(l, {bookType: "xlsx", bookSST: !1, type: "binary"});
            saveAs(new Blob([c(f)], {type: "application/octet-stream"}), "test.xlsx")
        }

        function u(e, t, n) {
            var a = t;
            a.unshift(e);
            var i = "SheetJS", s = new r, u = o(a);
            s.SheetNames.push(i), s.Sheets[i] = u;
            var l = XLSX.write(s, {bookType: "xlsx", bookSST: !1, type: "binary"}), d = n || "列表";
            saveAs(new Blob([c(l)], {type: "application/octet-stream"}), d + ".xlsx")
        }
        ...
        var n = {admin: {token: "admin-token"}, editor: {token: "editor-token"}}, a = {
            "admin-token": {
                roles: ["admin"],
        ...
        var o = n("96eb"), r = n("8a60"), c = r.param2Obj, s = n("331a"), u = n("a0bc"), l = [].concat(i(s), i(u));
            ...
            function e(e) {
                return function (t) {
                    ...
                    if (e instanceof Function) {
                        ...
                        n = e({method: i, body: JSON.parse(a), query: c(r)})
                    } else n = e;
                    return o.mock(n)
                }
            }
        ...
        var a = n("2b0e"), i = (n("f5df1"), n("5c96")), o = n.n(i), r = (n("0fae"), n("b2d6"), n("b20f"), function () {
            ...
            }, u = s, l = n("2877"), d = Object(l["a"])(u, r, c, !1, null, null, null), f = d.exports, h = n("2f62"),
            m = (n("b0c0"), {
                sidebar: function (e) {
        ...
        var P, U, q = n("8c4f"), X = function () {
                ...
                }, [n("span", {staticStyle: {display: "block"}}, [e._v("切换显示看板")])])], 1)], 1)], 1)], 1)
            ...
            }, se = ce, ue = (n("186a"), Object(l["a"])(se, oe, re, !1, null, "49e15297", null)), le = ue.exports, de = {
                created: function () {
                    this.currentTime()
                },
            ...
            }, fe = de, he = (n("9160"), Object(l["a"])(fe, F, J, !1, null, "3496e236", null)), me = he.exports,
            pe = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }), Be = Te, Ae = (n("bf4f"), Object(l["a"])(Be, P, U, !1, null, "18eeea00", null)), Re = Ae.exports,
            ze = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, rt = ot, ct = (n("9f2b"), Object(l["a"])(rt, X, G, !1, null, "4f739cf0", null)), st = ct.exports;
        a["default"].use(q["a"]);
        var ut = [{
            path: "/login", component: function () {
                return n.e("chunk-048417b2").then(n.bind(null, "9ed6"))
            }, hidden: !0
        }, {
            ...
            children: [{
                path: "/dashboard1", name: "Dashboard1", component: function () {
                    return Promise.all([n.e("chunk-2d0b8e66"), n.e("chunk-014c1b60")]).then(n.bind(null, "598f"))
                }, meta: {title: "主看板1", icon: "dashboard", roles: ["admin"]}
            }, {
                path: "/dashboard2", name: "Dashboard2", component: function () {
                    return Promise.all([n.e("chunk-2d0b8e66"), n.e("chunk-36f1634e")]).then(n.bind(null, "d5d0"))
                }, meta: {title: "主看板2", icon: "dashboard", roles: ["editor"]}
            }, {
                path: "/dashboard3", name: "Dashboard3", component: function () {
                    return Promise.all([n.e("chunk-2d0b8e66"), n.e("chunk-80c0ed4a")]).then(n.bind(null, "e1cf"))
            ...
            children: [{
                ...
                path: "unqualified", name: "Unqualified", component: function () {
                    return n.e("chunk-0c461f4c").then(n.bind(null, "46e9"))
            ...
            children: [{
                path: "product", name: "Product", component: function () {
                    return n.e("chunk-3cf3add8").then(n.bind(null, "371d"))
            ...
            children: [{
                path: "equipmentinfo", name: "Equipmentinfo", component: function () {
                    return n.e("chunk-27d140b4").then(n.bind(null, "9c1e"))
                ...
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            ...
                            a({path: "/dashboard1"}), At.a.done(), e.next = 31;
                            break;
                        case 11:
                        ...
                        case 20:
                            "admin-token" == o && a({path: "/dashboard1"}), "editor-token" == o && a({path: "/dashboard2"}), e.next = 31;
                            break;
                        case 24:
                            return e.prev = 24, e.t0 = e["catch"](17), e.next = 28, yt.dispatch("user/resetToken");
                        case 28:
            ...
            function (e) {
                ...
                var t = e.BlobBuilder || e.WebKitBlobBuilder || e.MozBlobBuilder || function (e) {
                    var t = function (e) {
                        ...
                        }, i = n.prototype, o = a.prototype, r = e.FileReaderSync, c = function (e) {
                        ...
                        u = s.length, l = e.URL || e.webkitURL || e, d = l.createObjectURL, f = l.revokeObjectURL,
                        h = l, m = e.btoa, p = e.atob, b = e.ArrayBuffer, v = e.Uint8Array;
                    a.fake = o.fake = !0;
                    while (u--) c.prototype[s[u]] = u + 1;
                    return l.createObjectURL || (h = e.URL = {}), h.createObjectURL = function (e) {
                        ...
                        if (v && (e instanceof b || e instanceof v)) {
                            for (var i = "", o = new v(e), s = 0, u = o.length; s < u; s++) i += String.fromCharCode(o[s]);
                            n.push(i)
